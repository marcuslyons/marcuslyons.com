import{a as o,t as a}from"./disclose-version.BDaRFh6M.js";import"./legacy.G1r-cTWw.js";import{n}from"./runtime.D22fzDCM.js";const i={title:"My Mac Setup 2018",slug:"my-mac-setup-2018",excerpt:"With such appearances as: Bear, VS Code, Brew, and many more!",date:"2018-03-27T00:00:00.000Z",published:!0,keywords:["homebrew","bear","spectacle","stay","flux","tomighty","pomodoro","window management","notetaking","markdown","package manager","macos","OSX","mac","Airmail","grammarly","alfred","spotlight","grammar","development","process","productivity"],previewText:`We all have a process and a preference for how we do things. As with anything
...
the App Store you’ll want to use <a href="https://github.com/mas-cli/mas" title="mas github repo" rel="nofollow" target="_blank">Mac App Store CLI</a>. Mas is
...
want it on your machine.</p> <p><a href="http://www.bear-writer.com/" title="Bear Homepage" rel="nofollow" target="_blank">Bear</a> I recently switched to Bear
after having used Evernote for four years. For one, Bear is <strong>fast</strong> and looks
...
notes across devices and unlock more themes.</p> <p>My <a href="https://www.codelyon.com/" title="codelyon.com" rel="nofollow" target="_blank">blog</a> uses Gatsby, a static site
...
and articles all in one location is quite handy.</p> <p><a href="https://www.spectacleapp.com/" title="Spectacle Homepage" rel="nofollow" target="_blank">Spectacle</a> One of the most
...
to Mac, and while Spectacle isn’t <em>quite</em> the same, it’s pretty damn close.</p> <p>Spectacle works via keyboard shortcuts, which is nice if you spend a <strong>lot</strong> of
time using one. Open source, and completely free. You can resize to fill the
full screen, center a window, halves, thirds, quarters.</p> <p><a href="https://cordlessdog.com/stay/" title="Stay Homepage" rel="nofollow" target="_blank">Stay</a> An annoying thing about
...
the application.</p> <p><a href="https://justgetflux.com/" title="Flux Homepage" rel="nofollow" target="_blank">f.lux</a> I’m likely not the only one,
but I tend to turn the brightness <strong>way</strong> down on my screens, MacBook and
...
my time, I have a slight yellow tinge to my display.</p> <p><a href="http://tomighty.org/" title="Tomighty Page" rel="nofollow" target="_blank">Tomighty</a> Oh, the mighty Pomodoro. I’ve
...
first apps I install when setting up a new machine.</p> <p><a href="http://airmailapp.com/" title="Airmail Homepage" rel="nofollow" target="_blank">Airmail</a> I find the default Mail app
...
fast package.</p> <p><a href="https://app.grammarly.com/" title="Grammarly Homepage" rel="nofollow" target="_blank">Grammarly</a> I use the free
...
enhancement.</p> <p><a href="https://www.alfredapp.com/" title="Alfred Homepage" rel="nofollow" target="_blank">Alfred</a> When I first discovered
...
the <a href="http://devdocs.io/" title="devdocs Homepage" rel="nofollow" target="_blank">devdocs</a> integration. Now I have the
...
it alone.</p>`,1);function y(e){var t=r();n(22),o(e,t)}export{y as default,i as metadata};
