...
[Flexbox Froggy](https://flexboxfroggy.com/) This is a fun game where you help a
frog and its friends navigate a pond with the help of flexbox.
...
[Flexbox Zombies](https://mastery.games/flexboxzombies/) Dave Geddes has created
multiple games, but the first I played of his was Flexbox Zombies. A free\* game
that teaches both basic and advanced concepts of flexbox.
...
[Grid Garden](https://cssgridgarden.com/) By the same maker as Flexbox Froggy
comes Grid Garden, where the goal is to take care of your garden of vegetables
by using the powers of CSS Grid.
...
[CSS Diner](https://flukeout.github.io/) This is **a good refresher** on the
basics of selectors and positioning in CSS. This was the first game I played
when learning HTML and CSS. I found it online one day and spent a fair amount of
time trying to beat it.
