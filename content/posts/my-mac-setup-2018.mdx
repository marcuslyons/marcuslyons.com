...
My [blog](https://www.codelyon.com/ "codelyon.com") uses Gatsby, a static site generator that can use Markdown to generate posts. Which Bear is compatible with rendering, unlike Evernote. Having the ability to keep post ideas, lists, notes, and articles all in one location is quite handy.
...
I use the free version but have considered getting a subscription. I write enough and forget how to spell enough to justify it. The better part of this app is the grammar enhancement.
